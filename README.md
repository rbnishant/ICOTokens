...
3. Add ethereum addresses and token amount in the file `airdrop.csv`(scripts->data->airdrop.csv). This file those addresses to which owner wants to send the tokens.
